            ...
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="POST" action="">
                        <div class="form-row">
							<div class="name requiredsign">Security <br> Question</div>
							<div class="value">
										...
										<div class="input-group" style="width: inherit;"> 
                                            <div class="rs-select2 js-select-simple select--no-search">
                                                <select class="stateselect" name="securityquestion"
                                                    id="securityquestion" style="width: 100%;">
                        ...
                        <div class="form-row">
							<div class="name requiredsign">Security <br> Answer</div>
							<div class="value">
								<div class="row row-refine">
									<div class="col-12">
                        ...
                        <div class="form-row">
                            <div class="centeralign">
                                <div class="input-group">
                                    <button class="btn btn--radius-2 btn--red" type="submit">Verify <i class="fa fa-chevron-circle-right" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                    </form>
