                ...
                <div class="card-body">
                    <form method="POST" action="LoginServlet">
                        ...
                        <div class="form-row">
                            <div class="name"></div>
                            <div class="value">
                                <div class="row row-refine forgotpassword">
                                    <a href="ForgotPasswordVerify.jsp" class="forgotpassword">Forgot Password ?</a>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="centeralign">
                                <div class="row row-refine">
                                    <p class="register">New User? <a href="index.html" class="forgotpassword">Register Here</a></p>
                                </div>
                            </div>
                        </div>
                    </form>
